% call after direct_int_reli.m
% - to ~verify the direct integration
% - to get sensitivity factors
...
eg = 0.5772156649015328606065120900824;
std_SWEas  = pi/sqrt(6)*sigma_SWEas;
mean_SWEas = mu_SWEas + sigma_SWEas*eg;

std_WS10aw  = pi/sqrt(6)*sigma_WS10aw;
mean_WS10aw = mu_WS10aw + sigma_WS10aw*eg;
...
probdata.marg =  [  2       5000        5000*0.2    5000        nan  nan  nan  nan 0;
                    11      mean_SWEas  std_SWEas   mean_SWEas  nan  nan  nan  nan 0;
                    11      mean_WS10aw std_WS10aw  mean_WS10aw nan  nan  nan  nan 0];

% Correlation matrix
probdata.correlation = eye(length(probdata.name));
probdata.correlation(2,3) = 0.3076610; %WARNING!
probdata.correlation(3,2) = 0.3076610; %WARNING!
...
analysisopt.num_sim              = 1e6;      % Number of samples (MC,IS), number of samples per subset step (SS) or number of directions (DS)
